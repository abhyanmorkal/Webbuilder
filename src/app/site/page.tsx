...
const Home = () => {
  return (
    <section className="w-full min-h-screen flex flex-col items-center relative overflow-x-hidden">
      <div className="absolute h-full top-0 z-[-2] w-screen bg-white bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]">
      ...
      <div className="font-sans font-extrabold px-5 text-center mt-5 text-xl lg:text-[32px]">
